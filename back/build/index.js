...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst productBusiness_1 = __webpack_require__(/*! ../business/productBusiness */ \"./src/app/business/productBusiness.ts\");\nconst productDTO_1 = __webpack_require__(/*! ../models/dto/productDTO */ \"./src/app/models/dto/productDTO.ts\");\nconst logUserBusiness_1 = __webpack_require__(/*! ../business/logUserBusiness */ \"./src/app/business/logUserBusiness.ts\");\nconst logUserDTO_1 = __webpack_require__(/*! ../models/dto/logUserDTO */ \"./src/app/models/dto/logUserDTO.ts\");\nclass ProductController {\n    constructor(productBusiness, logUserBusiness) {\n        if (ProductController.productBusiness == null) {\n            ProductController.productBusiness = productBusiness;\n        }\n        if (ProductController.logUserBusiness == null) {\n            ProductController.logUserBusiness = logUserBusiness;\n        }\n    }\n    listAll(req, res) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                let products = yield ProductController.productBusiness.findAll();\n                return res.status(200).json({\n                    products: products\n                });\n            }\n            catch (e) {\n                return res.status(400).json({ message: e.message });\n            }\n        });\n    }\n    create(req, res) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                let product = yield ProductController.productBusiness.create(productDTO_1.ProductDTO.cast(req.body));\n                yield ProductController.logUserBusiness.create(new logUserDTO_1.LogUserDTO(parseInt(req.body.user_id), \"Criar\", `Usuário criou o produto ${product.name}.`));\n                return res.status(201).json();\n            }\n            catch (e) {\n                return res.status(400).json({ message: e.message });\n            }\n        });\n    }\n    update(req, res) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                let productDTO = productDTO_1.ProductDTO.cast(req.body);\n                productDTO.id = parseInt(req.params.productId);\n                let product = yield ProductController.productBusiness.update(productDTO);\n                yield ProductController.logUserBusiness.create(new logUserDTO_1.LogUserDTO(parseInt(req.body.user_id), \"Atualizar\", `Usuário atualizou o produto ${product.name}.`));\n                return res.status(200).json({\n                    product: product\n                });\n            }\n            catch (e) {\n                return res.status(400).json({ message: e.message });\n            }\n        });\n    }\n    findById(req, res) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                let product = yield ProductController.productBusiness.findById(parseInt(req.params.productId));\n                return res.status(200).json({\n                    product: product\n                });\n            }\n            catch (e) {\n                return res.status(404).json({ message: e.message });\n            }\n        });\n    }\n    delete(req, res) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield ProductController.productBusiness.deleteById(parseInt(req.params.productId));\n                yield ProductController.logUserBusiness.create(new logUserDTO_1.LogUserDTO(parseInt(req.body.user_id), \"Deletar\", `Usuário removeu o produto ${req.params.prodictId}.`));\n                return res.status(204).json();\n            }\n            catch (e) {\n                return res.status(404).json({ message: e.message });\n            }\n        });\n    }\n}\nexports.ProductController = ProductController;\nexports.default = (new ProductController(new productBusiness_1.ProductBusiness(), new logUserBusiness_1.LogUserBusiness()));\n\n\n//# sourceURL=webpack:///./src/app/controllers/productController.ts?");
...
/***/ "./src/app/models/dto/logUserDTO.ts":
/*!******************************************!*\
  !*** ./src/app/models/dto/logUserDTO.ts ***!
  \******************************************/
/*! no static exports found */
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nclass LogUserDTO {\n    constructor(userId, operation, message) {\n        this.userId = userId;\n        this.operation = operation;\n        this.message = message;\n    }\n}\nexports.LogUserDTO = LogUserDTO;\n\n\n//# sourceURL=webpack:///./src/app/models/dto/logUserDTO.ts?");
